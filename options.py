...
def Infinity():
         ...
         print("EASY MODE")
         from infinity import main_game
         main_game()
...
def Basic():
         ...
         print("BASIC SNAKE GAME")
         from alter import SnakeGame
         SnakeGame()
...
def main_menu2():
    ...
    while True:
        ...
        EASYMODE_button = Button(image=pygame.image.load("assets/options Rect.png"), pos=(640, 250),
                             text_input="EASY MODE", font=get_font(55), base_color="#606c38", hovering_color="#454B1B")
        HARDMODE_button = Button(image=pygame.image.load("assets/options Rect.png"), pos=(640, 380),
                                text_input="HARD MODE", font=get_font(55), base_color="#606c38", hovering_color="#454B1B")
        BASICGAME_button = Button(image=pygame.image.load("assets/BASICSNAKE React.png"), pos=(640, 510),
                             text_input="BASIC SNAKE GAME", font=get_font(47), base_color="#606c38", hovering_color="#454B1B")
        menu_button = Button(image=pygame.image.load("assets/MENU React.png"), pos=(640, 630),
                             text_input="BACK TO MAIN MENU", font=get_font(50), base_color="#606c38", hovering_color="#454B1B")
        

        for button in [EASYMODE_button, HARDMODE_button, BASICGAME_button, menu_button]:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if EASYMODE_button.check_for_input(menu_mouse_pos):
                    Infinity()
                if HARDMODE_button.check_for_input(menu_mouse_pos):
                    Highspeed()
                if BASICGAME_button.check_for_input(menu_mouse_pos):
                    Basic()
